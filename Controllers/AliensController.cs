...
namespace L06HandsOn.Controllers
{
    public class AliensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BirthDate,Arms,Heads,Legs")] Alien alien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BirthDate,Arms,Heads,Legs")] Alien alien)
        {
            if (id != alien.Id)
            {
                return NotFound();
